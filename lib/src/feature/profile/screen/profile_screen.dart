...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> getProduct() async {
    ...
    if (id != null) {
      String? result = await NetworkService.get(Urls.profileContent,
          Urls.profileContentParam(id: id, size: 10), context);
      String? recipeNetworkData = await NetworkService.get(Urls.profileContent,
          Urls.profileContentParam(id: id, size: 10), context);
  ...
  Future<void> refreshData() async {
    ...
    await getProduct();
    await profileRepository.fetchUserProfile();
    setState(() {
    });
  }
                        ...
                        headerSliverBuilder: (context, innerBoxIsScrolled) => [
                              ...
                              SliverToBoxAdapter(
                                child: BlocProvider(
                                    ...
                                    child: userProfile.data?.description
                                                    ?.length !=
                                                null &&
